...
<html>
	<head>
		...
		<meta property="og:url" content="https://simprolitstroy.ru/pages/contacts" />
		<meta property="og:title" content="Контакты СимпролитСтрой" />
		<meta property="og:description" content />
		<meta property="og:type" content="website" />
		<!--   <meta property="og:image" content="fonts/ant-design_home-outl.svg"> -->
		<link rel="canonical" href="https://simprolitstroy.ru/pages/contacts" />
		<!--/metatextblock-->
			...
			<div class="modal-dialog modal-dialog-centered" style="max-width: 700px !important; ">
				<div class="modal-content text-center p-2 w-100 pb-4" style="max-width: 700px !important; border-radius: 20px;">
					<div class="">
						<button
							type="button"
							class="close w-100 text-right p-3"
							data-dismiss="modal"
							onclick="$('#formModal').modal('hide');"
							style="text-align: right; max-height: 0px; margin-top: -20px !important; background: none; border: none;"
						>
					...
					<div class="modal-body p-4 mt-3">
						<div class="row row-cols-1 rol-cols-sm-1 row-cols-md-2 row-cols-lg-3 g-3 pb-4" style="justify-content: center;">
							<div class="col col-lg-12">
								<input
									id="inputFormName"
									onfocus="hideMobFixedButtomButton();"
									onblur="showMobFixedButtomButton();"
									class="namer"
									type="text"
									placeholder="Ваше имя"
									size="40"
									style="box-shadow: 0px 13px 17px rgba(0, 0, 0, 0.04);
                            border-radius: 20px;"
								/>
							</div>
							<div class="col col-lg-12">
			...
			<div class="modal-dialog modal-dialog-centered" style="max-width: 700px !important; ">
				<div class="modal-content text-center p-2 w-100" style="max-width: 700px !important; border-radius: 20px;">
					<div class="">
						<button
							type="button"
							class="close w-100 text-right p-3 pb-3"
							data-dismiss="modal"
							onclick="$('#successModal').modal('hide');"
							style="text-align: right; max-height: 50px; margin-top: -10px !important; background: none; border: none;"
						>
							<span aria-hidden="true" style=" font-size: 50px !important;">&times;</span>
						</button>
