...
<div class="footer bg-dark w-100 relative-bottom">
    <div class="container pt-4">
        ...
        <div class="row row-cols-sm-5 py-4 border-top text-light">
            <div class="col">
                <a href="/" class="d-flex align-items-center mb-3 link-dark text-decoration-none">
                    <img src="https://static.tildacdn.info/tild3234-3161-4562-a330-323865646436/ant-design_home-outl.svg" alt="" />
                </a>
                <p class="text-muted">© 2022 Компания "СимпролитСтрой"</p>
            </div>
            <div class="col d-none d-sm-block"></div>
            <div class="col">
                <h5>Информация</h5>
                <ul class="nav flex-column" style="padding-top: 15px;">
                    <li class="nav-item mb-2 text-muted">Сайт носит исключительно информационный характер и не является публичной офертой</li>
...
<noscript>
    <div><img src="https://mc.yandex.ru/watch/88965053" style="position:absolute; left:-9999px;" alt="" /></div>
</noscript>
<!— /Yandex.Metrika counter —>
